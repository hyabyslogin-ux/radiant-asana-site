...
const SocialMedia = () => {
  const socialLinks = [
    ...
    },
    {
      ...
      description: "Quick yoga tips, fun challenges, and student transformations",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {socialLinks.map((social, index) => (
            <Card key={index} className="p-6 bg-gradient-card border border-yoga-rose/20 shadow-soft hover:shadow-glow transition-all duration-300 group cursor-pointer">
          ...
          <div className="bg-gradient-border rounded-2xl p-1 max-w-3xl mx-auto">
            <div className="bg-yoga-cream rounded-xl p-8">
              ...
              <p className="text-muted-foreground mb-6">
                Tag us in your yoga photos and use #baliyogaschool to be featured on our social media! 
                We love seeing your practice and celebrating your progress.
              </p>
