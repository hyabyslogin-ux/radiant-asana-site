...
const UbudCampusGallery = () => {
  ...
  // All gallery images from the uploads
  const allImages = [
    '/lovable-uploads/006e4b87-f686-4703-bc52-d499a78f67df.png',
    '/lovable-uploads/06842a42-8b88-42fa-a0a1-bb9e89492967.png',
    ...
    '/lovable-uploads/2be9a81e-5b6a-4e5f-b5af-a18a60b00cb1.png',
            ...
            <div className="columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4">
              {allImages.map((image, index) => (
                ...
                >
                  <img 
                    src={image} 
                    alt={`Ubud retreat campus view ${index + 1}`}
