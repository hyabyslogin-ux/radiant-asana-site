        ...
        <div className="relative text-center text-white px-6 max-w-4xl mx-auto">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6 text-sm">
              ...
              <span>8 Days Uluwatu Experience</span>
            </div>
            ...
            <p className="font-inter text-xl md:text-2xl text-white/90 max-w-2xl mx-auto leading-relaxed">
              Embark on an extended transformative journey combining intensive yoga practice, spiritual awakening, and profound healing in Uluwatu Bali's most sacred clifftop location
            </p>
          </div>
          ...
          <div className="relative">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-3 bg-white/60 backdrop-blur-sm rounded-full px-6 py-2 mb-6">
                ...
                <span className="font-inter text-yoga-earth font-medium">Extended Practice</span>
              </div>
              ...
              <p className="font-inter text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Experience the transformative power of our comprehensive 8-day yoga retreat in Uluwatu Bali. This extended journey offers deep spiritual exploration, advanced yoga practices, community connection, and overall transformation amidst the dramatic clifftop beauty and sacred energy of Uluwatu.
              </p>
            </div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-yoga-sage/20 rounded-full flex items-center justify-center">
                      <Waves className="w-5 h-5 text-yoga-sage" />
                    </div>
                    <div>
                      ...
                      <p className="font-inter text-gray-600 leading-relaxed">
                        Invigorating yoga sessions and calming meditation practices to center your mind and body.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-yoga-earth/20 rounded-full flex items-center justify-center">
                      <Utensils className="w-5 h-5 text-yoga-earth" />
                    </div>
                    <div>
                      <h4 className="font-playfair text-xl font-semibold text-yoga-earth mb-1">
                        Nourishing Meals
                      ...
                      <p className="font-inter text-gray-600 leading-relaxed">
                        Delicious and healthy meals prepared with fresh, local ingredients to fuel your body.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-yoga-rose/20 rounded-full flex items-center justify-center">
                      <Gift className="w-5 h-5 text-yoga-rose" />
                    </div>
                    <div>
                      <h4 className="font-playfair text-xl font-semibold text-yoga-earth mb-1">
                        Cultural Excursions
                      ...
                      <p className="font-inter text-gray-600 leading-relaxed">
                        Immerse yourself in Balinese culture with visits to local temples and traditional ceremonies.
                      </p>
                    </div>
                  </li>
                </ul>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-yoga-plum/20 rounded-full flex items-center justify-center">
                      <Clock className="w-5 h-5 text-yoga-plum" />
                    </div>
                    <div>
                      <h4 className="font-playfair text-xl font-semibold text-yoga-earth mb-1">
                      ...
                      <p className="font-inter text-gray-600 leading-relaxed">
                        Start your day with an energizing yoga session overlooking the ocean.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-yoga-sage/20 rounded-full flex items-center justify-center">
                      <Clock className="w-5 h-5 text-yoga-sage" />
                    </div>
                    <div>
                      <h4 className="font-playfair text-xl font-semibold text-yoga-earth mb-1">
                        9:00 AM - Breakfast
                      ...
                      <p className="font-inter text-gray-600 leading-relaxed">
                        Enjoy a healthy and delicious breakfast at our retreat center.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-playfair text-xl font-semibold text-yoga-earth mb-1">
                        11:00 AM - Cultural Excursion
                      </h4>
                      <p className="font-inter text-gray-600 leading-relaxed">
                        Visit a local temple or participate in a traditional Balinese ceremony.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                  ...
                  <li className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-yoga-peach/20 rounded-full flex items-center justify-center">
                      <Clock className="w-5 h-5 text-yoga-peach" />
                    </div>
                    <div>
                      <h4 className="font-playfair text-xl font-semibold text-yoga-earth mb-1">
                        7:00 PM - Dinner
                      ...
                      <p className="font-inter text-gray-600 leading-relaxed">
                        Enjoy a delicious and healthy dinner at our retreat center.
                      </p>
                    </div>
                  </li>
                </ul>
        ...
        <section className="bg-gradient-to-br from-yoga-earth/5 via-yoga-sage/5 to-yoga-plum/5 rounded-3xl p-12">
          <div className="text-center mb-12">
            ...
            <p className="font-inter text-xl text-gray-600 max-w-2xl mx-auto">
              Complete 8-day retreat experience in Uluwatu Bali
            </p>
          </div>
            ...
            <Card className="border-0 shadow-2xl bg-white/90 backdrop-blur-sm">
              <CardContent className="p-12">
                <div className="text-center mb-8">
                  <div className="text-6xl font-bold text-yoga-earth mb-4">$1,200</div>
                  <p className="text-xl text-gray-600">Complete 8-Day Experience</p>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-center gap-2">
                        ...
                        Multiple temple ceremony visits
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-rose rounded-full"></div>
                        Advanced cliff meditation practices
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-rose rounded-full"></div>
                        Deep Balinese cultural integration
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-rose rounded-full"></div>
                        Mentorship & life coaching sessions
                      </li>
                    </ul>
                  </div>
                </div>
...
export default UluwatuEightDaysRetreat;
