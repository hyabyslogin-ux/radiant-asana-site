        ...
        <div className="relative text-center text-white px-6 max-w-4xl mx-auto">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6 text-sm">
              ...
              <span>6 Days Uluwatu Experience</span>
            </div>
            ...
            <p className="font-inter text-xl md:text-2xl text-white/90 max-w-2xl mx-auto leading-relaxed">
              Embark on a profound 6-day journey of self-discovery and spiritual awakening in Uluwatu Bali's most sacred clifftop locations
            </p>
          </div>
          ...
          <div className="relative">
            <div className="text-center mb-16">
              ...
              <p className="font-inter text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Experience profound transformation with our intensive 6-day yoga retreat in Uluwatu Bali. This extended program offers deeper spiritual exploration, advanced yoga practices, and authentic Balinese healing traditions in one of the world's most spectacular clifftop settings.
              </p>
            </div>
            ...
            <div className="px-8 py-12 space-y-16">
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                  ...
                  <p className="font-inter text-lg text-gray-700 leading-relaxed">
                    Embark on a transformative journey through our carefully crafted 6-day yoga retreat in the dramatic clifftop setting of Uluwatu Bali. This immersive experience combines traditional <strong className="text-yoga-earth">Hatha Vinyasa yoga practices</strong> with authentic Balinese healing traditions, creating the perfect environment for physical rejuvenation and spiritual awakening.
                  </p>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="relative">
                  ...
                  />
                  <div className="absolute bottom-0 left-0 w-full h-16 bg-gradient-to-t from-black/80 to-transparent rounded-b-2xl"></div>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <p className="font-inter text-lg text-gray-700 leading-relaxed">
                    Experience the profound healing traditions of Bali with our expert practitioners. Our 6-day retreat includes daily sessions of traditional Balinese massage, known for its therapeutic benefits in releasing tension, improving circulation, and promoting overall well-being.
                  </p>
                  
                  <p className="font-inter text-lg text-gray-700 leading-relaxed">
                    In addition to massage, you'll have the opportunity to participate in a Melukat water purification ceremony at one of Uluwatu Bali's most sacred temples. This ancient ritual is designed to cleanse the mind, body, and spirit, leaving you feeling refreshed, renewed, and deeply connected to the island's spiritual energy.
                  </p>
                </div>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                  ...
                  <p className="font-inter text-lg text-gray-700 leading-relaxed">
                    Our 6-day retreat is structured to provide a balance of invigorating yoga practices, restorative healing sessions, and opportunities for personal reflection and growth. Each day begins with an early morning meditation and pranayama session, followed by a dynamic Hatha Vinyasa yoga class overlooking the ocean.
                  </p>
                  
                  <p className="font-inter text-lg text-gray-700 leading-relaxed">
                    Afternoons are dedicated to exploring Uluwatu Bali's cultural and natural wonders, with guided visits to ancient temples, breathtaking beaches, and traditional Balinese villages. Evenings conclude with restorative yoga, sound healing, and group sharing circles, creating a supportive community for your transformative journey.
                  </p>
                </div>
                ...
                <div className="relative">
                  <img 
                    ...
                    className="rounded-2xl shadow-xl"
                  />
                  <div className="absolute top-0 left-0 w-full h-16 bg-gradient-to-b from-black/80 to-transparent rounded-t-2xl"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-gradient-to-br from-yoga-earth/5 via-yoga-sage/5 to-yoga-plum/5 rounded-3xl p-12">
          <div className="text-center mb-12">
            ...
            <p className="font-inter text-xl text-gray-600 max-w-2xl mx-auto">
              Complete 6-day retreat experience in Uluwatu Bali
            </p>
          </div>
            ...
            <Card className="border-0 shadow-2xl bg-white/90 backdrop-blur-sm">
              <CardContent className="p-12">
                <div className="text-center mb-8">
                  <div className="text-6xl font-bold text-yoga-earth mb-4">$750</div>
                  <p className="text-xl text-gray-600">Complete 6-Day Experience</p>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-center gap-2">
                        ...
                        Advanced clifftop yoga sessions
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-sage rounded-full"></div>
...
export default UluwatuSixDaysRetreat;
