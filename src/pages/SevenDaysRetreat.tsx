              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                  ...
                  <p className="font-inter text-lg text-gray-700 leading-relaxed">
                    Embark on a transformative journey through our carefully crafted 7-day yoga retreat in the heart of Bali. This complete experience combines traditional <strong className="text-yoga-earth">Hatha Vinyasa yoga practices</strong> with authentic Balinese healing traditions, creating the perfect environment for physical rejuvenation and spiritual awakening.
                  </p>
          ...
          <div className="relative space-y-20">
            <div className="text-center">
              ...
              <p className="font-inter text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                We offer 7 Days & 6 Nights retreat throughout the year. Contact us to check the availability. We are always ready to welcome you.
              </p>
            </div>
              ...
              <div className="bg-gradient-to-br from-white/90 via-white/80 to-yoga-cream/20 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-white/50">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                  <div className="text-center group">
                    ...
                    <p className="font-inter text-sm text-gray-600">6 Nights Accommodation with Bathroom</p>
                  </div>
