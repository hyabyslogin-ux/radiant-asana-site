        ...
        <div className="relative text-center text-white px-6 max-w-4xl mx-auto">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6 text-sm">
              ...
              <span>7 Days Uluwatu Experience</span>
            </div>
            ...
            <p className="font-inter text-xl md:text-2xl text-white/90 max-w-2xl mx-auto leading-relaxed">
              A transformative week-long journey combining intensive yoga practice, spiritual awakening, and authentic Balinese wisdom in Uluwatu Bali's most sacred clifftop sanctuary
            </p>
          </div>
          ...
          <div className="relative">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-3 bg-white/60 backdrop-blur-sm rounded-full px-6 py-2 mb-6">
                ...
                <span className="font-inter text-yoga-earth font-medium">Intensive Journey</span>
              </div>
              ...
              <p className="font-inter text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Embark on a comprehensive 7-day spiritual journey in Uluwatu Bali, where ancient yogic wisdom meets dramatic clifftop beauty. This intensive retreat combines advanced yoga practices, deep meditation, authentic Balinese healing, and profound personal transformation.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="font-playfair text-2xl font-semibold text-yoga-earth">Spiritual Awakening</h3>
                </div>
                
                <p className="font-inter text-lg text-gray-700 leading-relaxed">
                  Our 7-day retreat is designed to facilitate a deep spiritual awakening through daily meditation, mindfulness practices, and sacred Balinese rituals. You'll learn to connect with your inner self, release limiting beliefs, and cultivate a profound sense of peace and purpose.
                </p>
              </div>
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="font-playfair text-2xl font-semibold text-yoga-earth">Advanced Yoga Practices</h3>
                </div>
                
                <p className="font-inter text-lg text-gray-700 leading-relaxed">
                  Deepen your yoga practice with our advanced asana classes, pranayama techniques, and yogic philosophy sessions. Our experienced instructors will guide you in exploring new dimensions of your physical and spiritual potential, regardless of your current level.
                </p>
              </div>
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="font-playfair text-2xl font-semibold text-yoga-earth">Authentic Balinese Healing</h3>
                </div>
                
                <p className="font-inter text-lg text-gray-700 leading-relaxed">
                  Experience the transformative power of traditional Balinese healing practices, including massage, energy work, and sacred ceremonies. These ancient techniques will help you release emotional blockages, restore balance to your energy field, and promote deep healing on all levels.
                </p>
              </div>
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="font-playfair text-2xl font-semibold text-yoga-earth">Profound Personal Transformation</h3>
                </div>
                
                <p className="font-inter text-lg text-gray-700 leading-relaxed">
                  Our 7-day retreat is designed to facilitate profound personal transformation through a combination of yoga, meditation, healing practices, and spiritual guidance. You'll leave feeling empowered, inspired, and ready to create a life of purpose, joy, and fulfillment.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-gradient-to-br from-yoga-earth/5 via-yoga-sage/5 to-yoga-plum/5 rounded-3xl p-12">
          <div className="text-center mb-12">
            ...
            <p className="font-inter text-xl text-gray-600 max-w-2xl mx-auto">
              Complete 7-day retreat experience in Uluwatu Bali
            </p>
          </div>
            ...
            <Card className="border-0 shadow-2xl bg-white/90 backdrop-blur-sm">
              <CardContent className="p-12">
                <div className="text-center mb-8">
                  <div className="text-6xl font-bold text-yoga-earth mb-4">$950</div>
                  <p className="text-xl text-gray-600">Complete 7-Day Experience</p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-center gap-2">
                        ...
                        Intensive clifftop yoga program
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-sage rounded-full"></div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-rose rounded-full"></div>
                        Ocean cliff sunrise & sunset practice
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-rose rounded-full"></div>
                        Complete Balinese cultural immersion
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-rose rounded-full"></div>
...
export default UluwatuSevenDaysRetreat;
