        ...
        <div className="relative text-center text-white px-6 max-w-4xl mx-auto">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6 text-sm">
              ...
              <span>6 Days Immersive Beach Experience</span>
            </div>
            ...
            <p className="font-inter text-xl md:text-2xl text-white/90 max-w-2xl mx-auto leading-relaxed">
              Dive deeper into Canggu's vibrant surf and wellness culture with our comprehensive 6-day beach yoga journey. Discover the perfect harmony between traditional yoga and contemporary beach lifestyle.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/30 text-white px-8 py-3">
              Book Your Extended Beach Journey - From $425
            </Button>
          </div>
        </div>
      </section>
        ...
        <section className="relative">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-3 bg-white/60 backdrop-blur-sm rounded-full px-6 py-2 mb-6">
              ...
              <span className="font-inter text-yoga-earth font-medium">6-Day Deep Beach Immersion</span>
            </div>
            ...
            <p className="font-inter text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Our 6-day retreat offers the perfect balance of intensive yoga practice and deep immersion into Canggu's creative beach culture. Experience extended transformation while connecting with the vibrant international community that calls Canggu home.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {[
              { icon: Waves, title: "Beach Yoga Mastery", desc: "Advanced beachside practice with ocean energy" },
              { icon: Gift, title: "Surf Culture Integration", desc: "Learn from Canggu's legendary surf community" },
              { icon: Utensils, title: "Wellness Café Culture", desc: "Explore organic nutrition in trendy beach cafés" },
              { icon: User, title: "Creative Community", desc: "Connect with digital nomads and artists" }
            ].map((feature, index) => (
              <div key={index} className="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-white/30 hover:scale-105">
                <div className="w-12 h-12 bg-gradient-to-br from-yoga-sage/20 to-yoga-earth/20 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  <feature.icon className="w-6 h-6 text-yoga-sage" />
                </div>
                <h3 className="font-playfair text-lg font-semibold text-yoga-earth mb-2">{feature.title}</h3>
                <p className="font-inter text-sm text-gray-600">{feature.desc}</p>
              </div>
            ))}
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">
                Your 6-Day Beach Journey
              </h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                A progressive experience from grounding beach practice to advanced surf-yoga integration
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                { days: "Days 5-6", title: "Mastery & Integration", desc: "Advanced practice and lifestyle integration techniques" }
              ].map((phase, index) => (
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
              Experience 6 comprehensive days of beach yoga and creative wellness in Canggu's vibrant community
            </p>

            <div className="bg-gradient-to-br from-primary/10 to-secondary/10 rounded-3xl p-8 md:p-12 shadow-2xl">
              <div className="text-6xl md:text-7xl font-bold text-primary mb-4">$2,100</div>
              <p className="text-xl text-muted-foreground mb-8">Complete 6-day Canggu immersive experience</p>
              
              <div className="grid md:grid-cols-2 gap-6 mb-8 text-left">
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    <span>6 days of advanced beach yoga</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    <span>Surf culture workshops & experiences</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    <span>All meals at Canggu's best cafés</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    <span>Beach massage & wellness treatments</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    <span>Street art & cultural tours</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Ready for an extended beach transformation? Connect with us to secure your spot in Canggu's most comprehensive yoga retreat
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <Card className="p-6 bg-card/80 backdrop-blur-sm border-primary/20">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Textarea 
                    name="message"
                    placeholder="Share your yoga experience and what draws you to Canggu's beach culture..." 
...
export default CangguSixDaysRetreat;