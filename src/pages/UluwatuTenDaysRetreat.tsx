    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="relative text-center text-white px-6 max-w-4xl mx-auto">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6 text-sm">
              ...
              <span>10 Days Uluwatu Experience</span>
            </div>
            ...
            <p className="font-inter text-xl md:text-2xl text-white/90 max-w-2xl mx-auto leading-relaxed">
              An immersive 10-day journey of total transformation, combining deep spiritual practice, community connection, and advanced yoga mastery in Uluwatu Bali's most sacred clifftop location
            </p>
          </div>
      ...
      <div className="container mx-auto px-4 py-16 space-y-24">
        ...
        <section className="relative">
          ...
          <div className="absolute bottom-10 left-10 w-40 h-40 bg-yoga-rose/15 rounded-full blur-3xl">
          ...
          <div className="relative">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-3 bg-white/60 backdrop-blur-sm rounded-full px-6 py-2 mb-6">
                ...
                <span className="font-inter text-yoga-earth font-medium">Complete Immersion</span>
              </div>
              ...
              <p className="font-inter text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Experience the ultimate transformation with our comprehensive 10-day yoga retreat in Uluwatu Bali. This immersive journey offers complete spiritual immersion, community connection, and advanced practice development amidst the spectacular beauty and sacred energy of Uluwatu's clifftop temples.
              </p>
            </div>
            ...
            <div className="px-8 py-12 space-y-16">
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                  ...
                  <p className="font-inter text-lg text-gray-700 leading-relaxed">
                    Embark on a transformative journey through our carefully crafted 10-day yoga retreat in the dramatic clifftop setting of Uluwatu Bali. This immersive experience combines traditional <strong className="text-yoga-earth">Hatha Vinyasa yoga practices</strong> with authentic Balinese healing traditions, creating the perfect environment for physical rejuvenation and spiritual awakening.
                  </p>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="relative">
                  <img 
                    ...
                    alt="Healing Practices"
                    className="rounded-2xl shadow-xl"
                  />
                  <div className="absolute bottom-4 right-4 bg-yoga-earth/80 text-white rounded-full px-4 py-2">
                ...
                <div className="space-y-8">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-yoga-rose to-yoga-peach rounded-xl flex items-center justify-center">
                  ...
                  <p className="font-inter text-lg text-gray-700 leading-relaxed">
                    Experience the profound healing traditions of Bali with our daily sessions led by local healers. These practices include traditional Balinese massage, energy healing, and chakra balancing, designed to release tension, restore harmony, and promote overall well-being.
                  </p>
                  
                  <ul className="list-disc list-inside space-y-2">
                    <li className="font-inter text-gray-700">Traditional Balinese Massage</li>
                    <li className="font-inter text-gray-700">Energy Healing Sessions</li>
                    <li className="font-inter text-gray-700">Chakra Balancing</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-yoga-plum to-yoga-cream rounded-xl flex items-center justify-center">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="font-inter text-lg text-gray-700 leading-relaxed">
                    Cultivate mindfulness and personal growth through our daily workshops and guided meditation sessions. Learn practical techniques to manage stress, enhance self-awareness, and cultivate a deeper connection with yourself and the world around you.
                  </p>
                  
                  <ul className="list-disc list-inside space-y-2">
                    <li className="font-inter text-gray-700">Mindfulness Workshops</li>
                    <li className="font-inter text-gray-700">Guided Meditation Sessions</li>
                    <li className="font-inter text-gray-700">Stress Management Techniques</li>
                  </ul>
                </div>
                ...
                <div className="relative">
                  <img 
                    ...
                    className="rounded-2xl shadow-xl"
                  />
                  <div className="absolute top-4 left-4 bg-yoga-sage/80 text-white rounded-full px-4 py-2">
        ...
        <section className="bg-gradient-to-br from-yoga-earth/5 via-yoga-sage/5 to-yoga-plum/5 rounded-3xl p-12">
          <div className="text-center mb-12">
            ...
            <p className="font-inter text-xl text-gray-600 max-w-2xl mx-auto">
              Complete 10-day retreat experience in Uluwatu Bali
            </p>
          </div>
            ...
            <Card className="border-0 shadow-2xl bg-white/90 backdrop-blur-sm">
              <CardContent className="p-12">
                <div className="text-center mb-8">
                  <div className="text-6xl font-bold text-yoga-earth mb-4">$1,800</div>
                  <p className="text-xl text-gray-600">Complete 10-Day Experience</p>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-center gap-2">
                        ...
                        Complete yoga immersion program
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-sage rounded-full"></div>
                      ...
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-sage rounded-full"></div>
                        Sacred healing intensives
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-sage rounded-full"></div>
                        Premium accommodation & gourmet meals
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-center gap-2">
                        ...
                        Complete temple ceremony cycle
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-rose rounded-full"></div>
                        Master-level cliff meditation training
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-rose rounded-full"></div>
                        Full Balinese spiritual integration
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yoga-rose rounded-full"></div>
                        Complete mentorship & life guidance program
                      </li>
                    </ul>
                  </div>
                </div>
...
export default UluwatuTenDaysRetreat;
